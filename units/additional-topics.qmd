...
Using `mytoy` as an example, set up automated testing with GitHub Actions in your `newton-practice` repository. Check that you can find the results under `https://github.com/<username>/newton-practice/actions.
